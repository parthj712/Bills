...
export default function MainHelpPage() {
  ...
  const handleSubmit = () => {
    ...
    window.open(`https://wa.me/919545934174?text=${encodedMessage}`, "_blank");
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        {[
          ...
          },
          {
            ...
            action: () => window.open("https://wa.me/919545934174", "_blank"),
          },
          // {
          //     title: "Email Support",
          //     icon: <EmailIcon />,
        ...
        <DialogContent sx={{ pt: 2 }}>
          ...
          <FormControl fullWidth margin="normal" error={!!errors.category}>
            ...
            >
              ...
              <MenuItem value="Printer Not Working">
                Printer Not Working
              </MenuItem>
          ...
          <FormControl fullWidth margin="normal" error={!!errors.issue}>
            ...
            >
              <MenuItem value="Unable to create bill">
                Unable to create bill
              </MenuItem>
              <MenuItem value="Payment failed">Payment failed</MenuItem>
              <MenuItem value="Report not generating">
