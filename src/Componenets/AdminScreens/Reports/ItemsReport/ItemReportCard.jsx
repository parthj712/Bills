      ...
      >
        ...
        <Box pb={2.5} pt={1.5} px={2.5} className="grid grid-cols-2 gap-3 mt-1">
          ...
          <Box>
            ...
            <Typography fontWeight={700}> {row.totalOrders} </Typography>{" "}
          </Box>{" "}
          <Box>
            {" "}
            <Typography fontSize={14} color="text.secondary">
            ...
            <Typography fontWeight={700}> {row.qtySold} </Typography>{" "}
          </Box>{" "}
          <Box>
            {" "}
            <Typography fontSize={14} color="text.secondary">
            ...
            <Typography fontWeight={600}> ₹ {row.unitPrice} </Typography>{" "}
          </Box>{" "}
          <Box>
            {" "}
            <Typography fontSize={14} color="text.secondary">
